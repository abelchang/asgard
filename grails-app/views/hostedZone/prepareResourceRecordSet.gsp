...
<div class="body">
  ...
  <g:form action="addResourceRecordSet" method="post" class="validate">
    <div>
      <table>
        <tbody valign="top">
        <tr class="prop">
        ...
        <tr class="prop">
          <td class="name">
            <label for="aliasTargetElbDnsName">Alias Target ELB DNS Name:</label>
          </td>
          <td class="longInput">
            <g:textField name="aliasTargetElbDnsName" value="${params.aliasTargetElbDnsName}"/>
          </td>
        </tr>
        </tbody>
      </table>
